        ...
        {!editing ? (
          <>
            ...
            <div className="flex gap-2 pt-2">
              <button onClick={() => setEditing(true)} className="rounded bg-neutral-800 px-3 py-1 text-xs">
                Editar
              </button>
              <button onClick={remove} disabled={busy} className="rounded bg-red-900/60 px-3 py-1 text-xs">
                Eliminar
              </button>
            </div>
          </>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="Horas"
                className="w-1/2 rounded bg-neutral-800 px-2 py-1 text-sm"
              />
              <input
                type="number"
                min={1}
            ...
            />
            <div className="flex gap-2">
              <button onClick={save} disabled={busy} className="rounded bg-emerald-600 px-3 py-1 text-xs">
                Guardar
              </button>
              <button onClick={() => setEditing(false)} className="rounded bg-neutral-800 px-3 py-1 text-xs">
                Cancelar
              </button>
            </div>
          </div>
